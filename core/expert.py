...
It's used to collect expert data to train the BehaviorClone model for warm starting PPO.
...
class Expert:
    def __init__(self):
        ...
        self.yPID = PIDController(kP=3.5, kD=2.0, limit=400.0)
    ...
    def getAction(self, state, target, dt):
